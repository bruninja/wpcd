...
function epico_blog_background_color() {
	...
	if ( ! empty( $blog_bkg_color ) && '#FFFFFF' !== $blog_bkg_color ) {
...
function epico_landing_page_background_color() {
	...
	if ( ! empty( $landing_bkg_color ) ) {
		...
		$custom_inline_style_landing_color = '.page-template-landing[class*="epc-"]{background:' . $landing_bkg_color . ';}.page-template-landing[class*="epc-"] #page{border-top: none !important}';
