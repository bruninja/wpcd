...
(function(factory) {  // Try to register as an anonymous AMD module
    ...
    var services = {
        facebook: {
            ...
            counterUrl: 'https://graph.facebook.com/v2.8/?fields=og_object{likes.summary(true).limit(0)},share&id={url}&access_token='+epico_script_vars.fb_app_id+'|'+epico_script_vars.fb_app_secret,
            convertNumber: function(data) {
                return data.share.share_count+data.share.comment_count+data.og_object.likes.summary.total_count;
            },
        ...
        twitter: {
            counterUrl: '//opensharecount.com/count.json?url={url}',
            convertNumber: function(data) {
                return data.count;
            },
        ...
        linkedin: {
            counterUrl: '//www.linkedin.com/countserv/count/share?url={url}',
            counter: function(jsonUrl, deferred) {
            ...
            popupUrl: '//www.linkedin.com/shareArticle?mini=false&url={url}&title={title}',
            popupWidth: 650,
            popupHeight: 500
        }
    };
...
jQuery( document ).ready( function() {
	...
	/* Videos responsivos. */
    jQuery( '.entry object, .entry embed, .entry iframe' ).not( 'embed[style*="display"], [src*="soundcloud.com"],[src*="infogr.am"],[name^="gform_"],iframe.wp-embedded-content' ).wrap( '<div class="embed-wrap" />' );
