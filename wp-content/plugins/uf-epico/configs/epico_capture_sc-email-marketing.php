...
$group = array(
	...
	'fields'   => array(
		...
		'email_field' => array(   // campo 09
			...
			'caption' => esc_attr__( 'Insert your email field ID.', 'uf-epico' ),
			'type'    => 'smalltextfield',
			'default' => '',
		),
		...
		'instructions'=> array(   // campo 15
			...
			'caption' => esc_attr__( 'Please also configure your MyMail form in "Newsletter > Forms" in your WordPress.', 'uf-epico' ),
			'type'    => 'paragraph',
			'default' => '',
		),
