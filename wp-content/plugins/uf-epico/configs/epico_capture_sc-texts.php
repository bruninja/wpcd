...
$group = array(
	...
	'fields'   => array(
		...
		'title_tag'   => array(
			...
			'type'    => 'dropdown',
			'default' => esc_attr__( '*0||Header level 4,1||Header level 3,2||Paragraph', 'uf-epico' ),
		),
		'intro_p'     => array(
			'label'   => esc_attr__( 'Intro text', 'uf-epico' ),
			'caption' => esc_attr__( 'Add a brief introductory text.', 'uf-epico' ),
			'type'    => 'textbox',
			'default' => esc_attr__( 'Please enter your email address below to get free blog updates!', 'uf-epico' ),
		),
		'placeholder' => array(
			...
			'type'    => 'textfield',
			'default' => esc_attr__( 'Your email', 'uf-epico' ),
		),
		'placeholder_name' => array(
			...
			'type'    => 'textfield',
			'default' => esc_attr__( 'Your name', 'uf-epico' ),
		),
