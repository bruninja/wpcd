<?php
$text = '<span class="noselection uf_epico_media_select button">' . __( 'Select Image', 'uf-epico' ) . '</span>';
$bg   = '';
...
if ( ! empty( $value ) ) {
	...
	if ( floatval( $attachment[0] ) > 0 ) {
		...
		$text = '<span class="remove">&times;</span>' . $setsize . $sizebuttons . '<span class="filechanger-btn uf_epico_media_select changer">' . __( 'Change Image', 'uf-epico' ) . '</span>';
		...
		$text = '<span class="remove">&times;</span><span class="filechanger-btn uf_epico_media_select changer">' . __( 'Change Image', 'uf-epico' ) . '</span><span class="preview">' . $sizes[0] . 'x' . $sizes[1] . '</span>';
...
echo '	<div class="image-field-uf-epico imgpreview" ' . $bg . '>' . $text . '</div>';
