...
(function ($) {
    ...
    $(function () {
        ...
        $.fn.selectChange = function () {
            ...
            var $child_3 = ':nth-child(1),:nth-child(2),:nth-child(9),:nth-child(21)';                                                          // Campaign Monitor
            ...
            var $child_6 = ':nth-child(1),:nth-child(2),:nth-child(3),:nth-child(5),:nth-child(7),:nth-child(21)';                              // Mailee.Me
            var $child_7 = ':nth-child(1),:nth-child(2),:nth-child(3),:nth-child(21)';                                                          // Mail Relay, Sendy
            var $child_8 = ':nth-child(1),:nth-child(18),:nth-child(21)';                                                                       // Klick Mail
            var $child_9 = ':nth-child(1),:nth-child(2),:nth-child(7),:nth-child(21)';                                                          // ActiveCampaign
            var $child_10 = ':nth-child(1),:nth-child(5),:nth-child(10),:nth-child(21)';                                                        // Benchmark
            var $child_12 = ':nth-child(1),:nth-child(5),:nth-child(8),:nth-child(11),:nth-child(14),:nth-child(21)';                           // Trafficwave
            var $child_13 = ':nth-child(1),:nth-child(2),:nth-child(7),:nth-child(13),:nth-child(21)';                                          // Infusionsoft
            var $child_14 = ':nth-child(1),:nth-child(2),:nth-child(5),:nth-child(9),:nth-child(21),:nth-child(22)';                            // Google Docs
            var $child_15 = ':nth-child(1),:nth-child(7),:nth-child(15),:nth-child(21)';                                                        // MyMail
            var $child_16 = ':nth-child(1),:nth-child(7),:nth-child(12),:nth-child(21)';                                                        // LeadLovers
            var $child_17 = ':nth-child(1),:nth-child(3),:nth-child(5),:nth-child(12),:nth-child(21)';                                          // MailPoet
            ...
            var $child_20 = ':nth-child(1),:nth-child(5),:nth-child(10),:nth-child(20),:nth-child(21)';                                         // RD Station
            ...
            if ($selected_values == 1 || $selected_values == 3 || $selected_values == 10) {
            ...
            } else if ($selected_values == 8 || $selected_values == 14) {
                $find_parent.filter($child_7).addClass($show_field).removeClass($hide_field); // Mail Relay, Sendy
                $find_parent.not($child_7).addClass($hide_field).removeClass($show_field);
            } else if ($selected_values == 9) {
                $find_parent.filter($child_8).addClass($show_field).removeClass($hide_field); // Klick Mail
            ...
            } else if ($selected_values == 15) {
                $find_parent.filter($child_10).addClass($show_field).removeClass($hide_field); // Benchmark
                $find_parent.not($child_10).addClass($hide_field).removeClass($show_field);
            } else if ($selected_values == 16) {
                $find_parent.filter($child_15).addClass($show_field).removeClass($hide_field); // MyMail
                ...
                $find_parent.filter($child_14).addClass($show_field).removeClass($hide_field); // Google Docs
